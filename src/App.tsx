...
import venueLinesData from "./data/venue-lines.json";
import "./App.css";

// Line numbers for the "Edit on GitHub" link. Generated by
// scripts/build-venue-lines.ts before each dev/build run.
const venueLines: Record<string, number> = venueLinesData;
            ...
            <div className="w-full sm:w-80 shrink-0 border-t sm:border-t-0 sm:border-l border-[#D9CDBF] flex flex-col p-4 sm:p-5 gap-3 sm:gap-4 sm:rounded-tr-2xl">
              ...
              <div className="mt-auto space-y-2">
                ...
                {/* Maintainer edit link — visible to everyone but only useful
                    if you have write access to the repo. Jumps to the
                    venue's row in venues.ts on GitHub using the line number
                    map generated by scripts/build-venue-lines.ts. */}
                <a
                  href={(() => {
                    const line = venueLines[venue.id];
                    const base =
                      "https://github.com/vonderluster/hk-wedding-venues/blob/main/src/data/venues.ts";
